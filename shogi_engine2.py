...
class Game_state:
    ...
    def __init__(self):
        ...
        # The number of moves done by the two players during the game.
        self.nb_moves = 0
    ...
    def update_legal_moves(self):
        ...
        # then we move the king or we capture the threatening piece or we block its path.
            ...
            self.add_legal_moves(king)
            # Threatening piece.
            thr_piece = list(self.PRI[side2][king.x, king.y])[0]
    ...
    def add_legal_board_moves_aux(self, piece, dpos):
        for dx, dy in dpos:
            ...
            if piece_xy == None or piece_xy.side != piece.side:
        ...
        for dx, dy in dpos:
            ...
            while 0 <= x <= 8 and 0 <= y <= 8:
                ...
                if piece_xy == None or piece_xy.side != piece.side:
                    ...
                    if piece_xy != None and piece_xy.side != piece.side:
                        break
                else:
                    break
                x, y = x + dx, y + dy
